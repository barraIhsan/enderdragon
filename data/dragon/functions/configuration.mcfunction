...
execute if score difficulty setting matches 0 run tellraw @s ["",{"text":"[ P ]","color":"green","clickEvent":{"action":"run_command","value":"/function dragon:configuration/difficulty/easy"},"hoverEvent": {"action": "show_text","contents": {"text": "Click to set the difficulty to Easy"}}},{"text":" Difficulty"}]
execute if score difficulty setting matches 1 run tellraw @s ["",{"text":"[ E ]","color":"dark_green","clickEvent":{"action":"run_command","value":"/function dragon:configuration/difficulty/normal"},"hoverEvent": {"action": "show_text","contents": {"text": "Click to set the difficulty to Normal"}}},{"text":" Difficulty"}]
execute if score difficulty setting matches 2 run tellraw @s ["",{"text":"[ N ]","color":"gray","clickEvent":{"action":"run_command","value":"/function dragon:configuration/difficulty/hard"},"hoverEvent": {"action": "show_text","contents": {"text": "Click to set the difficulty to Hard"}}},{"text":" Difficulty"}]
execute if score difficulty setting matches 3 run tellraw @s ["",{"text":"[ H ]","color":"red","clickEvent":{"action":"run_command","value":"/function dragon:configuration/difficulty/peaceful"},"hoverEvent": {"action": "show_text","contents": {"text": "Click to set the difficulty to Peaceful"}}},{"text":" Difficulty"}]
...
execute if score actionbar setting matches 0 run tellraw @s ["",{"text": "[ ❌ ]","color": "red","clickEvent": {"action": "run_command","value": "/function dragon:configuration/actionbar/enable"},"hoverEvent": {"action": "show_text","contents": {"text": "Click to Enable end crystal actionbar"}}},{"text":" End Crystal Actionbar"}]
execute if score actionbar setting matches 1 run tellraw @s ["",{"text": "[ ✔ ]","color": "green","clickEvent": {"action": "run_command","value": "/function dragon:configuration/actionbar/disable"},"hoverEvent": {"action": "show_text","contents": {"text": "Click to Disable end crystal actionbar"}}},{"text":" End Crystal Actionbar"}]
