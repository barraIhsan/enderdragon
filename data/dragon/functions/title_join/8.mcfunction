...
execute at @e[type=area_effect_cloud,tag=drg_player,limit=1,sort=nearest] as @p[tag=drg_title,distance=..1,sort=nearest] run title @s title {"text": "Welcome B","color": "green","bold": true}
...
schedule function dragon:title_join/9 4t
