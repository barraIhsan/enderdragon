...
execute if score keepinventory setting matches 0 run tellraw @s ["",{"text": "[ ❌ ]","color": "red","clickEvent": {"action": "run_command","value": "/function dragon:setting/keepinventory/enable"},"hoverEvent": {"action": "show_text","contents": {"text": "Click to Enable keep inventory\nIf people fell into the void, all items are missing!\nDo /execute as <player that die> run function dragon:init to recover the item\nIf they have end crystal, Do /scoreboard players set <player that die> DragonKiller 1","color": "#FFA500"}}},{"text":" Keep Inventory","color": "#FFA500"}]
execute if score keepinventory setting matches 1 run tellraw @s ["",{"text": "[ ✔ ]","color": "green","clickEvent": {"action": "run_command","value": "/function dragon:setting/keepinventory/disable"},"hoverEvent": {"action": "show_text","contents": {"text": "Click to Enable keep inventory\nIf people fell into the void, all items are missing!\nDo /execute as <player that die> run function dragon:init to recover the item\nIf they have end crystal, Do /scoreboard players set <player that die> DragonKiller 1","color": "#FFA500"}}},{"text":" Keep Inventory","color": "#FFA500"}]
...
execute if score actionbar setting matches 0 run tellraw @s ["",{"text": "[ ❌ ]","color": "red","clickEvent": {"action": "run_command","value": "/function dragon:setting/actionbar/enable"},"hoverEvent": {"action": "show_text","contents": {"text": "Click to Enable end crystal actionbar"}}},{"text":" Actionbar"}]
execute if score actionbar setting matches 1 run tellraw @s ["",{"text": "[ ✔ ]","color": "green","clickEvent": {"action": "run_command","value": "/function dragon:setting/actionbar/disable"},"hoverEvent": {"action": "show_text","contents": {"text": "Click to Disable end crystal actionbar"}}},{"text":" Actionbar"}]
