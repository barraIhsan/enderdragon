...
scoreboard players set helmet drg_kits 7
...
execute as @a if score @s drg_pumpkin matches 1 run replaceitem entity @s inventory.9 turtle_helmet{Unbreakable:1b}
