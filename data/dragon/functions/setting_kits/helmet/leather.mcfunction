...
scoreboard players set helmet drg_kits 1
...
execute as @a if score @s drg_pumpkin matches 1 run replaceitem entity @s inventory.9 leather_helmet{Unbreakable:1b}
