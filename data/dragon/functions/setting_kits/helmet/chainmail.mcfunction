...
scoreboard players set helmet kits 3
...
execute as @a if score @s wear_pumpkin matches 1 run replaceitem entity @s inventory.9 chainmail_helmet{Unbreakable:1b}
