...
replaceitem entity @s armor.chest minecraft:chainmail_chestplate{Unbreakable:1b} 1
replaceitem entity @s armor.legs minecraft:chainmail_leggings{Unbreakable:1b} 1
replaceitem entity @s armor.feet minecraft:chainmail_boots{Unbreakable:1b} 1
replaceitem entity @s weapon.offhand minecraft:shield{Unbreakable:1b} 1
replaceitem entity @s inventory.0 minecraft:arrow 16
replaceitem entity @s inventory.9 minecraft:chainmail_helmet{Unbreakable:1b} 1
replaceitem entity @s inventory.18 minecraft:crossbow{Unbreakable:1b} 1
replaceitem entity @s hotbar.0 bow{Unbreakable:1b} 1
replaceitem entity @s hotbar.1 minecraft:stone_sword{Unbreakable:1b} 1
replaceitem entity @s hotbar.2 minecraft:stone_pickaxe{Unbreakable:1b} 1
replaceitem entity @s hotbar.3 minecraft:stone_axe{Unbreakable:1b} 1
replaceitem entity @s hotbar.4 minecraft:stone_shovel{Unbreakable:1b} 1
...
tellraw @s "Stomail kit selected"
