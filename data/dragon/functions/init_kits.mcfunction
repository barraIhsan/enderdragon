...
execute if score helmet kits matches 1 run replaceitem entity @s armor.head leather_helmet
execute if score helmet kits matches 2 run replaceitem entity @s armor.head golden_helmet
execute if score helmet kits matches 3 run replaceitem entity @s armor.head chainmail_helmet
execute if score helmet kits matches 4 run replaceitem entity @s armor.head iron_helmet
execute if score helmet kits matches 5 run replaceitem entity @s armor.head diamond_helmet
execute if score helmet kits matches 6 run replaceitem entity @s armor.head netherite_helmet

# Chestplate
execute if score chestplate kits matches 0 run replaceitem entity @s armor.chest air
execute if score chestplate kits matches 1 run replaceitem entity @s armor.chest leather_chestplate
execute if score chestplate kits matches 2 run replaceitem entity @s armor.chest golden_chestplate
execute if score chestplate kits matches 3 run replaceitem entity @s armor.chest chainmail_chestplate
execute if score chestplate kits matches 4 run replaceitem entity @s armor.chest iron_chestplate
execute if score chestplate kits matches 5 run replaceitem entity @s armor.chest diamond_chestplate
execute if score chestplate kits matches 6 run replaceitem entity @s armor.chest netherite_chestplate

# Leggings
execute if score leggings kits matches 0 run replaceitem entity @s armor.legs air
execute if score leggings kits matches 1 run replaceitem entity @s armor.legs leather_leggings
execute if score leggings kits matches 2 run replaceitem entity @s armor.legs golden_leggings
execute if score leggings kits matches 3 run replaceitem entity @s armor.legs chainmail_leggings
execute if score leggings kits matches 4 run replaceitem entity @s armor.legs iron_leggings
execute if score leggings kits matches 5 run replaceitem entity @s armor.legs diamond_leggings
execute if score leggings kits matches 6 run replaceitem entity @s armor.legs netherite_leggings

# Boots
execute if score boots kits matches 0 run replaceitem entity @s armor.feet air
execute if score boots kits matches 1 run replaceitem entity @s armor.feet leather_boots
execute if score boots kits matches 2 run replaceitem entity @s armor.feet golden_boots
execute if score boots kits matches 3 run replaceitem entity @s armor.feet chainmail_boots
execute if score boots kits matches 4 run replaceitem entity @s armor.feet iron_boots
execute if score boots kits matches 5 run replaceitem entity @s armor.feet diamond_boots
execute if score boots kits matches 6 run replaceitem entity @s armor.feet netherite_boots
